...
from lawofmessiah_app.lib.bible_reference_parser import ParsedBibleReference
from lawofmessiah_app.models import LawOfMessiah, LawOfMessiahBibleReference
from lawofmessiah_website.settings import BASE_DIR
...
class Command(BaseCommand):
    ...
    def _parse_single_reference(self, reference_text):
        ...
        try:
            parsed = ParsedBibleReference.create_from_string(candidate)
        except Exception:
            return None
